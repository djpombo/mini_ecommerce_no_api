...
function ListarCidades(props) {
    ...
    function ListaCidades(sigla) {
        ...
        let dadosEstado = ListagemDeCidades.estados.filter(estado => estado.sigla === sigla);

        return dadosEstado[0].cidades;
    ...
    useEffect(() => {
        function consultaCidades() {
            ...
            let cidadesLista = ListaCidades(props.estado);
